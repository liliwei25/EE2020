...
HD_PWD='D:/Vivado/Projects/ee2020_with_vga/ee2020_with_vga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dual_gen.vdi -applog -m64 -messageDb vivado.pb -mode batch -source dual_gen.tcl -notrace
