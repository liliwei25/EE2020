...
HD_PWD='D:/Vivado/Projects/ee2020_with_vga/ee2020_with_vga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dual_gen.vds -m64 -mode batch -messageDb vivado.pb -notrace -source dual_gen.tcl
